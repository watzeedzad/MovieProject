...
CREATE TABLE IF NOT EXISTS `int203_project`.`Award` (
  ...
  PRIMARY KEY (`awardId`),
  INDEX `fk_Award_AwardType1_idx` (`awardType` ASC),
  CONSTRAINT `fk_Award_AwardType1`
    FOREIGN KEY (`awardType`)
    REFERENCES `int203_project`.`AwardType` (`awardTypeId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- -----------------------------------------------------
-- Table `int203_project`.`SoundtrackComposer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `int203_project`.`SoundtrackComposer` (
...
CREATE TABLE IF NOT EXISTS `int203_project`.`Soundtrack` (
  ...
  INDEX `fk_Soundtrack_SoundtrackCompressor1_idx` (`composerId` ASC),
  ...
  CONSTRAINT `fk_Soundtrack_SoundtrackCompressor1`
    ...
    REFERENCES `int203_project`.`SoundtrackComposer` (`composerId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS `int203_project`.`Movie` (
  ...
  CONSTRAINT `fk_Movie_Studio1`
    ...
    REFERENCES `int203_project`.`Studio` (`studioId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `int203_project`.`StarringAward` (
  `starringId` INT NOT NULL,
  `awardId` INT NULL,
  INDEX `fk_StarringAward_Starring1_idx` (`starringId` ASC),
...
-- -----------------------------------------------------
-- Table `int203_project`.`MovieAward`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `int203_project`.`MovieAward` (
  `movieId` INT NOT NULL,
  `awardId` INT NULL,
  INDEX `fk_MovieAward_Movie1_idx` (`movieId` ASC),
  INDEX `fk_MovieAward_Award1_idx` (`awardId` ASC),
  CONSTRAINT `fk_MovieAward_Movie1`
    FOREIGN KEY (`movieId`)
    REFERENCES `int203_project`.`Movie` (`movieId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_MovieAward_Award1`
    FOREIGN KEY (`awardId`)
    REFERENCES `int203_project`.`Award` (`awardId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
